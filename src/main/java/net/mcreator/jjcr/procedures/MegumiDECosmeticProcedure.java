...
public class MegumiDECosmeticProcedure {
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												...
												("execute as @s run title @s subtitle {\"text\":\"" + "Chimera Shadow Garden" + "\", \"bold\":\"true\", \"color\":\"" + "dark_gray" + "\"}"));
									}
								}
								{
									Entity _ent = entityiterator;
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4, _ent.getName().getString(),
														_ent.getDisplayName(), _ent.level().getServer(), _ent),
												("execute as @s run title @s subtitle {\"text\":\"" + "\u0422\u0435\u043D\u0435\u0432\u043E\u0439 \u0421\u0430\u0434 \u0425\u0438\u043C\u0435\u0440" + "\", \"bold\":\"true\", \"color\":\"" + "dark_gray"
														+ "\"}"));
									}
								}
								{
			...
			if (world.getLevelData().getGameRules().getBoolean(JjcrModGameRules.JJCR_COSMETIC_DE_VOICE_OVER)) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:megumi_domain_jp")), SoundSource.VOICE, 50, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:megumi_domain_jp")), SoundSource.VOICE, 50, 1, false);
					}
				}
			}
		});
