...
public class HanamiDECosmeticProcedure {
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												...
												("execute as @s run title @s subtitle {\"text\":\"" + "Ceremonial Sea of Light" + "\", \"bold\":\"true\", \"color\":\"" + "yellow" + "\"}"));
									}
								}
								{
									Entity _ent = entityiterator;
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4, _ent.getName().getString(),
														_ent.getDisplayName(), _ent.level().getServer(), _ent),
												("execute as @s run title @s subtitle {\"text\":\"" + "\u0426\u0435\u0440\u0435\u043C\u043E\u043D\u0438\u0430\u043B\u044C\u043D\u043E\u0435 \u041C\u043E\u0440\u0435 \u0421\u0432\u0435\u0442\u0430"
			...
			if (world.getLevelData().getGameRules().getBoolean(JjcrModGameRules.JJCR_COSMETIC_DE_VOICE_OVER)) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:hanami_domain_jp")), SoundSource.VOICE, 50, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:hanami_domain_jp")), SoundSource.VOICE, 50, 1, false);
					}
				}
			}
		});
