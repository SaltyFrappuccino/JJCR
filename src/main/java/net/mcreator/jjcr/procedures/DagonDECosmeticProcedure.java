...
public class DagonDECosmeticProcedure {
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												...
												("execute as @s run title @s subtitle {\"text\":\"" + "Horizon of the Captivating Skandha" + "\", \"bold\":\"true\", \"color\":\"" + "dark_aqua" + "\"}"));
									}
								}
								{
									Entity _ent = entityiterator;
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4, _ent.getName().getString(),
														_ent.getDisplayName(), _ent.level().getServer(), _ent),
												("execute as @s run title @s subtitle {\"text\":\""
														+ "\u041F\u043B\u0435\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u044B\u0439 \u0413\u043E\u0440\u0438\u0437\u043E\u043D\u0442 \u0421\u043A\u0430\u043D\u0434\u0445\u0438"
			...
			if (world.getLevelData().getGameRules().getBoolean(JjcrModGameRules.JJCR_COSMETIC_DE_VOICE_OVER)) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:dagon_domain_jp")), SoundSource.VOICE, 50, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:dagon_domain_jp")), SoundSource.VOICE, 50, 1, false);
					}
				}
			}
		});
