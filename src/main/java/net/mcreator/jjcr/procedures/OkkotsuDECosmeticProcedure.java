...
public class OkkotsuDECosmeticProcedure {
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												...
												("execute as @s run title @s subtitle {\"text\":\"" + "Authentic Mutual Love" + "\", \"bold\":\"true\", \"color\":\"" + "light_purple" + "\"}"));
									}
								}
								{
									Entity _ent = entityiterator;
								...
								}
								{
									...
									if (!_ent.level().isClientSide() && _ent.getServer() != null) {
										_ent.getServer().getCommands().performPrefixedCommand(
												new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4, _ent.getName().getString(),
														_ent.getDisplayName(), _ent.level().getServer(), _ent),
												("execute as @s run title @s subtitle {\"text\":\"" + "\u0418\u0441\u0442\u0438\u043D\u043D\u0430\u044F \u0427\u0438\u0441\u0442\u0430\u044F \u041B\u044E\u0431\u043E\u0432\u044C"
			...
			if (world.getLevelData().getGameRules().getBoolean(JjcrModGameRules.JJCR_COSMETIC_DE_VOICE_OVER)) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:okkotsu_domain_jp")), SoundSource.VOICE, 50, 1);
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jjcr:okkotsu_domain_jp")), SoundSource.VOICE, 50, 1, false);
					}
				}
			}
		});
