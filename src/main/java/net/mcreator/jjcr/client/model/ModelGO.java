package net.mcreator.jjcr.client.model;
...
public class ModelGO<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jjcr", "model_go"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = root.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(16, 22).addBox(-4.0F, 6.0F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 38).addBox(-4.0F, 6.0F, -2.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)),
